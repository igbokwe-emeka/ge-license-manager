...
LOG_BUCKET=_Default
LOG_VIEW=_AllLogs
LOG_DATASET=logging_analytics
INACTIVITY_THRESHOLD_DAYS=45

# Subscription settings
# Optional: Comma-separated list of GCP Project IDs where GE subscriptions are located.
# If not set, GCP_PROJECT_ID is used.
#SUBSCRIPTION_IDS=${PROJECT_ID}
...
echo "  Agent is accessible to ALL users in your GE App."
